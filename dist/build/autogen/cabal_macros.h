...
/* package inferInstance-0.1.0.0 */
#define VERSION_inferInstance "0.1.0.0"
#define MIN_VERSION_inferInstance(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "inferInstance-0.1.0.0-4OAtfHgWbQuIQFfU4K6eA9"

#define CURRENT_PACKAGE_KEY "inferInstance-0.1.0.0-4OAtfHgWbQuIQFfU4K6eA9"
